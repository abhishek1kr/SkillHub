---
name: fv-mov-2-cl2-capability-lifecycle
description: Capability objects (AdminCap, TreasuryCap) should be created only once during module initialization (init). Creating them in any other function, without requiring an existing capability, allows any caller to mint new admin credentials. S...
category: general
---
