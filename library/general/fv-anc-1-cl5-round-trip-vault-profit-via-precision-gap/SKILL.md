---
name: fv-anc-1-cl5-round-trip-vault-profit-via-precision-gap
description: A deposit followed by an immediate withdrawal can extract value when share-to-asset conversion rounds in the depositor's favor at both steps. When both mint and redeem paths round down at the asset level, an attacker can systematically d...
category: general
---
