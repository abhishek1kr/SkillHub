---
name: fv-anc-5-cl7-invoke-signed-with-wrong-or-partial-seeds
description: If the seeds array passed to invokesigned does not exactly match the seeds used to derive the PDA that is expected to sign, the call will fail or sign under the wrong identity. More critically, when multiple seed combinations can resolve...
category: general
---
