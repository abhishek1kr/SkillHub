---
name: fv-anc-5-cl2-cpi-without-signer-seeds
description: When a CPI requires a PDA to sign on behalf of the program, invokesigned must be called with the correct signer seeds. Using invoke or passing empty seeds to invokesigned causes the CPI to fail or to execute without the PDA's authority, ...
category: general
---
