---
name: state-transition-mapper
description: Discovery approach: Map the state machine, verify operation postconditions, check paired-operation symmetry, and ensure entity counts stay consistent.
category: general
---
