---
name: fv-ton-7-cl1-jetton-wallet-validation
description: Accepting Jetton deposits without verifying the sender is the legitimate wallet (derived from the minter's StateInit) lets attackers send fake transfernotification messages to credit themselves with tokens they never transferred.
category: general
---
