---
name: fv-sol-5-c6-same-block-snapshot-abuse
description: Protocols that calculate yield, rewards, voting power, or insurance coverage based on a balance snapshot at a single point in time are vulnerable to flash loan amplification. An attacker borrows tokens, deposits before the snapshot (or i...
category: general
---
