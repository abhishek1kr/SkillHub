---
name: ton-checks
description: - Check every recvinternal handler for transfernotification - verify senderaddress is compared against a stored, initialized Jetton wallet address, not just the fromuser field inside the payload body - Look for acceptmessage() in recvext...
category: general
---
