---
name: fv-sol-9-c8-dust-griefing
description: Two griefing patterns exploiting minimal-cost interactions: a dust deposit with no minimum amount can reset a per-user timelock indefinitely, and a dust token transfer to a contract can permanently block a zero-balance gate that guards a...
category: general
---
