---
name: fv-sol-3-c4-misuse-of-environment-variables
description: Environment variables such as block.timestamp, block.number, and block.basefee carry miner- or validator-influenced values that should not be used as precise inputs to arithmetic or access control. Small manipulations of block.timestamp ...
category: network
---
