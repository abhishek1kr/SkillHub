---
name: fv-mov-2-cl4-sender-spoofing
description: A function accepts a sender: address parameter to determine the caller's identity, rather than deriving it from txcontext::sender(ctx). Any caller can spoof any address by passing a victim's address, enabling them to perform operations o...
category: general
---
