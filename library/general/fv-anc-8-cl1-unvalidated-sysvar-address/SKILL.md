---
name: fv-anc-8-cl1-unvalidated-sysvar-address
description: Solana sysvars (Clock, Rent, SlotHashes, etc.) have fixed public addresses. If a sysvar is accepted as an AccountInfo without verifying its address, an attacker can substitute a different account, causing the program to read attacker-con...
category: general
---
