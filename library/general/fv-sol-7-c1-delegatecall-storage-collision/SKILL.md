---
name: fv-sol-7-c1-delegatecall-storage-collision
description: delegatecall executes code from another contract in the calling contract's storage context, preserving msg.sender and msg.value. When the proxy and implementation contracts declare state variables at overlapping storage slots, writes fro...
category: general
---
