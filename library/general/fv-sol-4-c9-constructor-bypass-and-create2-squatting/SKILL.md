---
name: fv-sol-4-c9-constructor-bypass-and-create2-squatting
description: Two related patterns allow attackers to bypass access controls that assume msg.sender is an EOA or a not-yet-deployed address. During construction, extcodesize is zero even though the caller is a contract, allowing constructor-context ca...
category: general
---
