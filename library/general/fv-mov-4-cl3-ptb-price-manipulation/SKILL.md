---
name: fv-mov-4-cl3-ptb-price-manipulation
description: Sui PTBs allow up to 1024 operations in one atomic transaction. An attacker can compose: (1) borrow via flash loan, (2) manipulate an on-chain price oracle or pool reserve ratio, (3) call the vulnerable function at the manipulated price,...
category: general
---
