---
name: fv-mov-4-cl4-clock-and-time
description: Sui provides reliable on-chain time via clock::timestampms(&clock), which returns time in milliseconds. Common failures: (1) Clock not used at all; (2) time constants mixed between milliseconds and seconds; (3) no deadline parameter on t...
category: general
---
