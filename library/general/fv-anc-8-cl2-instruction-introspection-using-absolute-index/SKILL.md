---
name: fv-anc-8-cl2-instruction-introspection-using-absolute-index
description: Programs that call loadinstructionatchecked(index, ...) with a hardcoded or fixed index assume a specific transaction layout. An attacker can prepend additional instructions, shifting the intended instruction to a different position and ...
category: general
---
