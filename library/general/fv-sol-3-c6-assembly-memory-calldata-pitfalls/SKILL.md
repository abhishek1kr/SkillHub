---
name: fv-sol-3-c6-assembly-memory-calldata-pitfalls
description: Inline assembly bypasses Solidity's memory safety guarantees. Six distinct pitfalls arise from incorrect memory layout assumptions, dirty bits, scratch space reuse, and calldata boundary handling. Each manifests as silent data corruption...
category: general
---
