---
name: 20-saml
description: <!-- AFTER: inject evil assertion. Signature still validates (covers legit). App processes the FIRST assertion found = evil. -- <saml:Response <saml:Assertion ID="evil" <NameIDadmin@company.com</NameID <!-- Attacker-controlled -- </saml:...
category: api
---
