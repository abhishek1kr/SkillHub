---
name: fv-ton-1-cl2-bounce-message-handling
description: Contracts that send messages but lack a bounce handler - or whose handler misparses the bounced body - leave state permanently inconsistent when the sent message fails, because there is no rollback path.
category: general
---
