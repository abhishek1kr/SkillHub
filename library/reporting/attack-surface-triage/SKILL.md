...
description: bash Parameters worth testing cat /tmp/urls.txt | grep -E "[?&](id|user|file|path|url|redirect|next|src|token|key|apikey)=" | tee /tmp/interesting-params.txt
category: reporting
---
