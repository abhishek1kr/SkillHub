---
name: templates
description: Write x-ray.md using this exact structure. Every line should tell an auditor something useful — write for someone who has 5 minutes to decide where to look first.
category: reporting
---
