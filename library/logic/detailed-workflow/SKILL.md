...
description: Companies <250 employees are exempt from Article 30 ONLY if: - Processing is occasional (NOT true for regular customer/employee data) - Processing is not high-risk - Processing excludes special categories (health, biometric, genetic, etc.)
category: logic
---
