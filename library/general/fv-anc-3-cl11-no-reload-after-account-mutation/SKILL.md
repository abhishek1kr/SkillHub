---
name: fv-anc-3-cl11-no-reload-after-account-mutation
description: In Anchor, after mutating an account via a loadmut() or direct field write, subsequent reads of the same account may use a stale in-memory copy. Without explicitly reloading, the program may act on outdated state, leading to logic errors...
category: general
---
