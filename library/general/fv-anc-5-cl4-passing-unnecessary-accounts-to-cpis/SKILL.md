---
name: fv-anc-5-cl4-passing-unnecessary-accounts-to-cpis
description: Including accounts in a CPI that the callee does not need expands the trust surface. A malicious callee can read data from, or attempt privileged operations on, any account passed to it. Each unnecessary account increases the blast radiu...
category: general
---
