---
name: fv-sol-6-c4-false-positive-success-assumption
description: The contract captures a failure signal from an external call but treats the failure path as a no-op, allowing execution to continue as if the call succeeded. This produces state inconsistencies and incorrect balance or permission assumpt...
category: general
---
