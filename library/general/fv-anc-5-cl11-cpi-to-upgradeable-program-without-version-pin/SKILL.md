---
name: fv-anc-5-cl11-cpi-to-upgradeable-program-without-version-pin
description: Calling an upgradeable program via CPI exposes the caller to logic changes introduced by the program's upgrade authority. If the calling protocol does not pin the expected program binary hash or validate the upgrade slot, an upgrade to t...
category: general
---
