---
name: fv-sol-10-c5-chainlink-feed-validity
description: latestRoundData() returns multiple fields that must all be validated. Missing any check leaves the protocol vulnerable to stale prices, deprecated feeds, and decimal scaling errors. Staleness means updatedAt is older than the feed's conf...
category: general
---
