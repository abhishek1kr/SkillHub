---
name: fv-mov-3-cl1-init-upgrade-assumptions
description: In Sui Move, the init function runs only once at first deployment. Package upgrades do NOT re-execute init. Code that relies on init running again to reset state, create new capabilities, or initialize new fields will leave post-upgrade ...
category: general
---
