---
name: fv-anc-11-cl1-missing-slippage-tolerance-allowing-extraction
description: Instructions that perform token swaps, liquidity operations, or price-sensitive conversions without a caller-supplied minimum output amount allow extractors to sandwich the transaction. On Solana, MEV via Jito bundles means any public tr...
category: general
---
