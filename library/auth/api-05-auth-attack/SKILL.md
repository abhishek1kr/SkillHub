...
description: API authentication attack testing: credential stuffing, rate-limit bypass via IP rotation, token reuse/replay, JWT manipulation in API context, OAuth token interception, and multi-factor auth bypass. Use when testing API authentication s...
category: auth
---
