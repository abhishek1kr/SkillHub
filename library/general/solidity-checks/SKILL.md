...
description: After detecting the protocol type, run cat $SKILLDIR/reference/solidity/protocols/<file for the matching row. Each file contains protocol-specific preconditions, detection heuristics, and historical exploit patterns cross-referenced to f...
category: general
---
