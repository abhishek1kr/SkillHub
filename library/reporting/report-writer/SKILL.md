---
name: report-writer
description: Role: Read the completed fuzzing suite outputs (coverage, corpus, campaign logs, properties, handlers) and produce the final report.md. This agent runs AFTER forge build and the FoundryTester sanity test have already passed — it is a pur...
category: reporting
---
