---
name: fv-sol-1-c2-cross-function
description: Multiple functions within the same contract share a state variable. One function makes an external call before updating that variable, while another function relies on the same variable for access control or accounting. An attacker re-en...
category: general
---
