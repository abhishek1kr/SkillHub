---
name: fv-sol-9-c4-reentrancy-loops
description: Loops that perform external calls on each iteration compound two risks: unbounded gas cost from the iteration itself, and reentrancy from any external call within the loop body. A malicious recipient can re-enter the looping function mid...
category: general
---
