---
name: synthesizer
description: Role: Merge outputs from 5 specialized invariant discovery agents into a consolidated property plan that maps to the Fizz harness architecture.
category: general
---
