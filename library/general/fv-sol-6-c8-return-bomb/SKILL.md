---
name: fv-sol-6-c8-return-bomb
description: When a contract makes an external call using (bool success, bytes memory data) = target.call(payload), the EVM copies the full returndata into memory. A malicious or compromised target can return enormous amounts of data, causing the cal...
category: general
---
