---
name: workflows
description: 1. EternalBlue exploitation is noisy and easily detected by IDS/IPS 2. Modern EDR solutions detect named pipe and service creation patterns 3. Exploitation may crash the target system (especially on 32-bit systems) 4. Use only against co...
category: network
---
