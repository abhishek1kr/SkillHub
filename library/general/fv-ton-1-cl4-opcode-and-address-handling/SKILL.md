---
name: fv-ton-1-cl4-opcode-and-address-handling
description: Unhandled or silently accepted unknown opcodes, incorrect bounceable/non-bounceable address flags, and missing workchain validation each create distinct attack surfaces in message routing.
category: general
---
