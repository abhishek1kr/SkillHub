---
name: fv-anc-9-cl1-not-using-discriminators-to-validate-account-types
description: Anchor automatically prepends an 8-byte discriminator to every [account] struct. When deserializing accounts manually or accepting them via UncheckedAccount, failing to check the discriminator allows an attacker to pass an account of a d...
category: general
---
