---
name: fv-mov-5-cl2-division-and-underflow
description: Move has no floating-point types. Early division truncates precision: (amount / total) price can round to zero for small amounts, enabling dust exploits. Division by zero causes an abort, which can permanently DoS critical operations. Su...
category: general
---
