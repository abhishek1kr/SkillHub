---
name: fv-ton-6-cl3-balance-logic-and-self-destruct
description: Using the contract's raw TON balance for business decisions is manipulable since anyone can send TON to any contract. Send mode flag +32 accidentally included in non-terminal paths destroys the contract permanently when its balance reach...
category: general
---
