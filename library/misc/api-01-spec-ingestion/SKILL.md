...
description: API specification ingestion and attack surface mapping skill. Covers OpenAPI/Swagger parsing, endpoint enumeration, authentication scheme detection, parameter discovery, and API documentation analysis for security testing. Use when begin...
category: misc
---
