---
name: api-reference
description: | Command | Description | |---------|-------------| | setkeys | Add/update AWS keys for the active session | | swapkeys | Switch between stored key sets in the session | | importkeys <profile | Import keys from ~/.aws/credentials (use --...
category: cloud
---
