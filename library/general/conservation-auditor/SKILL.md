...
description: Discovery approach: For every aggregate/total variable, write a "sum of individual parts = tracked whole" property. This is the 1 bug-finding pattern in DeFi history.
category: general
---
