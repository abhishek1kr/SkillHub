---
name: fv-sol-10-c3-manipulation-through-external-markets
description: Oracles that aggregate prices from low-liquidity external markets (DEXes, AMMs) can be temporarily skewed within a single block or flash loan transaction. A protocol using such a price without smoothing or secondary validation executes c...
category: general
---
