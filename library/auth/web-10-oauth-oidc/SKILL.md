...
description: OAuth 2.0 / OIDC attack methodology for web applications: redirecturi bypass, state parameter abuse, CSRF on OAuth flow, authorization code interception, PKCE bypass, scope escalation, and token leakage via Referer. Use when testing web ...
category: auth
---
