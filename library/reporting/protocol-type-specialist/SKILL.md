---
name: protocol-type-specialist
description: Discovery approach: Auto-detect the protocol type from PROTOCOLCONTEXT, then apply battle-tested property templates specific to that protocol category.
category: reporting
---
