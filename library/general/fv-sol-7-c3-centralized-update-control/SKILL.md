---
name: fv-sol-7-c3-centralized-update-control
description: When upgrade authority is held by a single EOA or unconstrained admin address, a compromised or malicious key holder can replace the implementation with arbitrary code, draining funds or bricking the contract. This represents a critical ...
category: general
---
