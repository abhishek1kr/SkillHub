---
name: fv-anc-13-cl3-upgrade-authority-not-transferred-or-locked
description: Anchor programs deployed with a live upgrade authority can be modified by the authority holder at any time without on-chain governance or timelock. If the upgrade authority is a single keypair rather than a multisig or locked to None, a ...
category: general
---
