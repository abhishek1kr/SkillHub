---
name: fv-ton-8-cl1-ownership-and-access
description: Tact's Ownable trait provides ownership infrastructure, but authorization is opt-in per handler. Any receive() handler that performs privileged state changes without calling self.requireOwner() is accessible to any sender.
category: general
---
