---
name: fv-sol-8-c4-unexpected-gas-increase
description: When a swap wrapper forwards execution to an external DEX without a gas cap, an attacker or a malicious/upgraded DEX implementation can consume unbounded gas. This drives up transaction costs, can cause out-of-gas reverts for the user, o...
category: general
---
