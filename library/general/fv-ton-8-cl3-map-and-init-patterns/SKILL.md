---
name: fv-ton-8-cl3-map-and-init-patterns
description: Tact map<K,V types are unbounded by default and lack built-in size tracking. The init() function can be replayed post-deployment if no initialized guard is present, overwriting all contract state including the owner.
category: general
---
