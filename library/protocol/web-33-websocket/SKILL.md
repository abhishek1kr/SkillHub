...
description: WebSocket security testing skill for offensive security and bug bounty. Covers WebSocket hijacking (CSWH), message injection, authentication bypass, origin validation flaws, and protocol-level attacks. Use when testing WebSocket endpoint...
category: protocol
---
