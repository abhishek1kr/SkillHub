---
name: fv-anc-13-cl1-compute-budget-dos-via-user-injected-limit-instruction
description: Solana transactions can include a SetComputeUnitLimit instruction that caps the compute units available for the entire transaction. A malicious user can prepend a SetComputeUnitLimit with a very low value before calling a protocol instru...
category: general
---
