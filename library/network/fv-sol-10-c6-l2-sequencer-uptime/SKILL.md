---
name: fv-sol-10-c6-l2-sequencer-uptime
description: On L2 networks (Arbitrum, Optimism, Base, and others), Chainlink price feeds continue to serve the last known price during sequencer downtime. When the sequencer resumes, there is a brief window where prices may be stale relative to L1 m...
category: network
---
