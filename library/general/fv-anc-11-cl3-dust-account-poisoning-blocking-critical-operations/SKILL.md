---
name: fv-anc-11-cl3-dust-account-poisoning-blocking-critical-operations
description: An attacker can send a tiny lamport amount to a program-controlled account, increasing its balance above the rent-exempt minimum for zero bytes but below what a later close or realloc operation expects. This can cause close constraints t...
category: general
---
