---
name: fv-sol-7-c6-proxy-upgrade-lifecycle
description: The upgrade lifecycle - initialization, authorization, and execution ordering - has several critical failure modes including re-initialization via wrong modifier, permanent loss of upgrade capability when UUPS logic is dropped, race cond...
category: general
---
