---
name: lending
description: Applies to: TON lending protocols, collateralized borrowing contracts, vault share protocols, Jetton-based money markets, stablecoin CDPs, over-collateralized loan contracts, flash loan providers, any FunC or Tact contract that issues sh...
category: general
---
