---
name: fv-sol-4-c3-lack-of-multi-signature-for-crucial-operations
description: When a single address controls a critical operation - such as draining contract funds, upgrading implementation logic, or changing protocol parameters - that address is a single point of failure. Compromise, loss, or coercion of that one...
category: general
---
