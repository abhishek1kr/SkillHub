---
name: fv-anc-10-cl3-unintended-closure-by-close-constraint
description: Anchor's close constraint closes the account and transfers its lamports at the end of the instruction, regardless of what the instruction body does. Applying it to accounts that should only conditionally be closed, or misunderstanding wh...
category: general
---
