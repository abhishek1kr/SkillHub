---
name: web-20-cors
description: CORS misconfiguration testing skill for offensive security. Covers origin reflection, null origin bypass, regex bypass, wildcard with credentials, HTTP protocol downgrade, subdomain trust abuse, and pre-flight OPTIONS bypass. Use when te...
category: xss
---
