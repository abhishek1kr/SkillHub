---
name: fv-anc-4-cl2-pda-seed-concatenation-collision
description: When multiple variable-length byte slices are passed as PDA seeds without length disambiguation, different combinations of inputs can produce the same raw seed bytes and therefore the same PDA address. An attacker can craft inputs that c...
category: general
---
