---
name: fv-sol-8-c1-price-manipulation
description: Relying solely on a DEX's own spot price to validate or derive swap parameters allows an attacker to manipulate the pool state (via flash loan or large trade) immediately before the victim transaction, causing extreme slippage. Without c...
category: general
---
