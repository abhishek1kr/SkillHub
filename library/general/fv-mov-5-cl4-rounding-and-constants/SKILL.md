---
name: fv-mov-5-cl4-rounding-and-constants
description: Vault and share protocols must round against the user to prevent slow pool drain: deposits should issue fewer shares (round down), withdrawals should return fewer tokens (round up). First-depositor vault inflation exploits the absence of...
category: general
---
