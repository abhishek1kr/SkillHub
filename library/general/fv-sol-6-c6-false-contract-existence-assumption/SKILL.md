---
name: fv-sol-6-c6-false-contract-existence-assumption
description: Calling a function on an address that contains no contract code does not revert - the EVM treats it as a successful call returning empty data. When a protocol stores or accepts an external address without verifying it is a deployed contr...
category: general
---
