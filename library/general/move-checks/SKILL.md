---
name: move-checks
description: - Check every function accepting Coin<T or generic <T - confirm T is validated against a whitelist or phantom type constraint on the container; unvalidated generics are the number-one critical finding in real Move audits - Search for pub...
category: general
---
