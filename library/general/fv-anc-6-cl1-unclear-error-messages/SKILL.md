---
name: fv-anc-6-cl1-unclear-error-messages
description: Using generic Solana ProgramError variants instead of custom Anchor error codes makes it impossible for clients, indexers, and auditors to determine why a transaction failed. Opaque errors also impede incident response and make it harder...
category: general
---
