---
name: fv-vyp-5-c1-block-timestamp-manipulation
description: block.timestamp in Vyper exposes the same miner-manipulable value as Solidity. Validators (post-Merge) can adjust the timestamp within the protocol's allowed drift to influence time-dependent logic such as auction deadlines, vesting clif...
category: general
---
