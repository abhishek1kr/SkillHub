---
name: fv-anc-7-cl7-unconstrained-freeze-authority
description: A token account can be frozen by the mint's freeze authority at any time, permanently preventing deposits, withdrawals, and transfers. Protocols that accept tokens from mints where freeze authority has not been revoked expose themselves ...
category: reporting
---
