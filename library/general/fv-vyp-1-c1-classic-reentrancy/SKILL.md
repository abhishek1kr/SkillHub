---
name: fv-vyp-1-c1-classic-reentrancy
description: Classic reentrancy occurs when a Vyper contract performs an external call before updating its own state, allowing a malicious callee to re-enter the function and exploit the stale state. Vyper provides the @nonreentrant decorator as a bu...
category: general
---
