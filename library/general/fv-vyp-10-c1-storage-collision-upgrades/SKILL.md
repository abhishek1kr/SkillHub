---
name: fv-vyp-10-c1-storage-collision-upgrades
description: Vyper assigns storage slots sequentially in declaration order, without the EIP-1967 slot reservation pattern used by many Solidity proxy frameworks. When an upgradeable proxy delegates to a new implementation that reorders or inserts sto...
category: general
---
