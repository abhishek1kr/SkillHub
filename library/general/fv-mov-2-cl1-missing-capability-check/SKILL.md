---
name: fv-mov-2-cl1-missing-capability-check
description: A function that performs admin or privileged operations (withdraw, mint, pause, config update) does not require a capability object parameter. Any user can call the function and perform admin operations without restriction.
category: general
---
