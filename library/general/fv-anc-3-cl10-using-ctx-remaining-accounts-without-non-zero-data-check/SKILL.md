---
name: fv-anc-3-cl10-using-ctx-remaining-accounts-without-non-zero-data-check
description: An uninitialized account on Solana has all-zero data. Accepting such an account from ctx.remainingaccounts without checking that it contains non-zero data allows an attacker to pass an empty system account that will be deserialized as a ...
category: general
---
