---
name: fv-mov-3-cl3-struct-field-evolution
description: Sui Move enforces forward-compatible struct evolution: fields may only be appended, never reordered or removed. Violating this rule causes existing on-chain objects (created by the old code) to fail deserialization when accessed by the n...
category: general
---
