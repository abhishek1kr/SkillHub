---
name: fv-mov-3-cl2-version-check-missing
description: After a package upgrade, old transactions may still call functions from the pre-upgrade package against existing shared objects. Without a version field and a per-function version assertion, old and new code can interleave, producing inc...
category: general
---
