---
name: nft-gaming
description: Applies to: NFT marketplaces, NFT minting contracts, play-to-earn games, on-chain games, gamefi, NFT staking, trait-based NFTs, SeaDrop-style, OpenSea-style
