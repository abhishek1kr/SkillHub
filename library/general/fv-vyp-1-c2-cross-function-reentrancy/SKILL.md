---
name: fv-vyp-1-c2-cross-function-reentrancy
description: Cross-function reentrancy occurs when an external call in one function allows a re-entrant attacker to invoke a different function in the same contract while shared state is still inconsistent. Vyper's @nonreentrant decorator prevents th...
category: general
---
