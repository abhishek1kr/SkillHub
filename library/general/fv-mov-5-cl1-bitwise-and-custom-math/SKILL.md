---
name: fv-mov-5-cl1-bitwise-and-custom-math
description: Move checks standard arithmetic overflow and aborts, but bitwise left-shift (<<) is NOT checked - it silently overflows. This vector directly caused the Cetus $223M exploit: a checkedshlw function had an incorrect shift limit (256 instea...
category: general
---
