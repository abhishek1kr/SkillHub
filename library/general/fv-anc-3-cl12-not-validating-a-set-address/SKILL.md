---
name: fv-anc-3-cl12-not-validating-a-set-address
description: When an instruction stores a new address into an account field (e.g., updating a treasury, fee recipient, or authority), failing to validate that address allows arbitrary pubkeys to be set. This can redirect funds, grant privileges to at...
category: general
---
