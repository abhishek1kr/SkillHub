---
name: fv-anc-4-cl4-pda-purpose-isolation-failure
description: When different instruction handlers derive PDAs using identical or overlapping seed sets, an attacker can substitute one PDA in place of another. Instructions that accept a PDA account by key alone without validating its discriminator or...
category: general
---
