...
description: Save the report to {project-name}-pashov-ai-audit-report-{timestamp}.md in the current working directory, where {project-name} is the repo root basename and {timestamp} is YYYYMMDD-HHMMSS at scan time.
category: reporting
---
