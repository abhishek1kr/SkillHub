---
name: fv-sol-1-c5-dynamic
description: Dynamic reentrancy arises when the target of an external call is a user-supplied parameter rather than a hardcoded or whitelist-verified address. Even with correct CEI ordering, the external call hands control to attacker-controlled code...
category: general
---
