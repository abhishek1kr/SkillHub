---
name: fv-sol-2-c1-token-decimals
description: Precision errors occur when contracts hardcode a decimal assumption (commonly 18) rather than reading the token's actual decimals() value. When a contract interacts with tokens like USDC (6 decimals) or WBTC (8 decimals) using an 18-deci...
category: general
---
