---
name: fv-anc-5-cl1-lack-of-validation-of-external-program-before-cpi
description: When the program ID for a CPI target is passed as an account in the transaction rather than hardcoded, an attacker can substitute a malicious program. Without validating the program ID before calling, the CPI executes arbitrary attacker-...
category: general
---
