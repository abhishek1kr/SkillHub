---
name: fv-sol-9-c6-blacklistable-token-payment
description: Push-model payment loops that transfer tokens to recipient addresses will revert entirely if any recipient is blacklisted by the token contract (USDC, USDT, and other compliant stablecoins support blacklisting). A single blacklisted addr...
category: logic
---
