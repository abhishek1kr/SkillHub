---
name: fv-anc-5-cl3-not-unsetting-signer-status-before-a-cpi
description: When a user-signed account is passed into a CPI, the callee receives it with issigner = true. A malicious or compromised callee can exploit this elevated status to perform privileged operations on the user's account that the caller did n...
category: general
---
