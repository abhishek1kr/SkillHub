---
name: fv-sol-4-c6-arbitrary-external-call
description: When a contract executes target.call{value: v}(data) where target or data are caller-supplied, an attacker can craft parameters to invoke unintended functions on any target contract. Common impact includes draining ERC20 allowances the c...
category: general
---
