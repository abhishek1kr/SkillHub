---
name: fv-sol-1-c8-erc777-hook-reentrancy
description: ERC777 tokens are backward-compatible with ERC20 but fire tokensToSend (on sender) and tokensReceived (on recipient) hooks via the ERC1820 registry on every transfer, including ERC20-style transfer() and transferFrom(). A protocol that u...
category: general
---
