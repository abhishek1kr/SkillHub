---
name: governance
description: Applies to: DAO governance, on-chain voting, governance token voting, timelocks, proposal execution, treasury management, Compound Governor-style, OpenZeppelin Governor-style
category: general
---
