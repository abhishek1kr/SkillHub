---
name: fv-sol-4-c5-callback-authorization-bypass
description: External callback functions (onFlashLoan, onERC721Received, onERC1155Received) are invoked by third-party contracts. If the callback does not verify msg.sender is the expected caller, anyone can invoke it directly with fabricated paramet...
category: general
---
