---
name: fv-vyp-9-c1-unbounded-loops
description: Vyper requires loop bounds to be statically known at compile time, but a loop over a DynArray iterates up to the declared maximum length, which can be reached at runtime. When the array grows through user-controlled appends, the gas cost...
category: general
---
