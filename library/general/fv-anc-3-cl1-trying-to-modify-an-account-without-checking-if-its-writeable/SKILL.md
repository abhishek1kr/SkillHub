---
name: fv-anc-3-cl1-trying-to-modify-an-account-without-checking-if-its-writeable
description: Solana requires accounts to be marked writable in the transaction's account list before the runtime permits lamport or data changes. Writing to an account not flagged as writable will either panic or silently fail depending on the Solana...
category: general
---
