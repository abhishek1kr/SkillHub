---
name: fv-ton-4-cl2-send-mode-flags
description: Incorrect sendrawmessage mode flags can drain the contract's balance (mode 128 without reserve), cause the contract to pay gas for user operations (mode 1 with user-controlled amounts), mask critical send failures (mode +2), or accidenta...
category: general
---
