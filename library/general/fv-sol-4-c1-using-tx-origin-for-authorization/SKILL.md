---
name: fv-sol-4-c1-using-tx-origin-for-authorization
description: tx.origin always resolves to the original EOA that initiated the transaction, regardless of how many contracts the call passed through. A malicious contract invoked by a privileged user can exploit this to impersonate that user in any co...
category: general
---
