---
name: fv-mov-6-cl4-dust-and-cleanup
description: Three related cleanup failures: (1) tiny token amounts ("dust") prevent object closure, enabling attacker to permanently lock victim accounts; (2) parent objects deleted without removing dynamic fields, permanently orphaning stored value...
category: general
---
