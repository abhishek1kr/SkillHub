---
name: fv-anc-11-cl5-time-unit-mismatch-in-deadline-validation
description: Solana's Clock sysvar provides both unixtimestamp (seconds since Unix epoch) and slot (current slot number). Mixing these two units in deadline or expiry comparisons produces incorrect results: a value stored in seconds interpreted as a ...
category: general
---
