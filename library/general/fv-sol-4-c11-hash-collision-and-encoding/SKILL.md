---
name: fv-sol-4-c11-hash-collision-and-encoding
description: Two encoding bugs allow attackers to produce colliding hashes or bypass deduplication. When abi.encodePacked is used with two or more dynamic-type arguments, inputs with different field boundaries but identical concatenated bytes produce...
category: general
---
