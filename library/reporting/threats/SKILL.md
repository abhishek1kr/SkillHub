---
name: threats
description: HOW TO USE THIS FILE Treat this file as a threat identification library, not as a prose template for the final report. - In Step 2e (Protocol Classification) — use the detection-signals table to label the protocol by type. - In Step 3a (...
category: reporting
---
