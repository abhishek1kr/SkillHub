---
name: fv-anc-5-cl6-post-cpi-ownership-change
description: A callee program can call assign on any account it is authorized to write, changing that account's owner to an arbitrary program. If the caller does not re-verify account ownership after the CPI, it may continue operating on an account n...
category: general
---
