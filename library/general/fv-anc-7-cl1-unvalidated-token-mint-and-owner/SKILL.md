---
name: fv-anc-7-cl1-unvalidated-token-mint-and-owner
description: Token accounts on Solana carry a mint and an owner field. Without validating both, an attacker can substitute a token account for a different mint (causing the program to treat the wrong token as the expected asset) or a different owner ...
category: general
---
