---
name: fv-mov-1-cl1-copy-ability-duplication
description: A value-bearing object (coin, NFT, badge, receipt, staking position) granted the copy ability can be duplicated by any holder. The attacker duplicates a token to drain pools, inflate supply, or repeatedly spend the same credential.
category: general
---
