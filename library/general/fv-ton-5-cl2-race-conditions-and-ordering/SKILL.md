---
name: fv-ton-5-cl2-race-conditions-and-ordering
description: Message ordering between different source contracts is not guaranteed on TON. Only messages from the same sender to the same receiver maintain order via logical time - cross-contract flows can interleave unpredictably, causing race condi...
category: general
---
