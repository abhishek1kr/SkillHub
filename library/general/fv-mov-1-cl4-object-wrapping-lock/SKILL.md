---
name: fv-mov-1-cl4-object-wrapping-lock
description: A contract wraps a user-owned object inside its own struct (or dynamic field) and provides no guaranteed path to unwrap it. Once wrapped, the inner object loses its independent identity - it cannot be transferred, used, or accessed until...
category: general
---
