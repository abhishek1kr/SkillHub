---
name: fv-vyp-4-c2-gas-griefing-external-calls
description: When a Vyper contract forwards all available gas to an untrusted external callee via rawcall, a malicious recipient can consume the gas intentionally to cause the transaction to run out of gas, or execute arbitrary expensive logic to gri...
category: general
---
