---
name: fv-anc-10-cl1-closing-accounts-without-zeroing-data-and-setting-a-closed-discriminator
description: Manually closing an account by zeroing its lamports without also zeroing its data and writing a closed discriminator leaves the account readable as if still active. An attacker can revive the account within the same transaction or exploi...
category: general
---
