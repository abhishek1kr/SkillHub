---
name: fv-sol-10-c7-missing-price-bounds
description: An oracle can return a technically valid price - passing all staleness, round, and sign checks - that is wildly wrong for protocol purposes, such as during a flash crash or when a Chainlink circuit breaker activates. Without min/max sani...
category: general
---
