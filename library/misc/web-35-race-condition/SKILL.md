...
description: Race condition vulnerability testing: TOCTOU, single-packet attacks, parallel request amplification, coupon/gift-card/withdrawal race conditions, MFA bypass via timing, and HTTP/2 multiplex smuggling. Use when testing concurrent request ...
category: misc
---
