---
name: fv-sol-10-c2-price-drift
description: An oracle price that drifts gradually from reality causes cumulative accounting errors that compound over time. Because no reference price is stored and no deviation band is enforced, each incremental update silently accepts a slightly-w...
category: general
---
