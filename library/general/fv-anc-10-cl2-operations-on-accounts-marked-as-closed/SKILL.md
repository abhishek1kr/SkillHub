---
name: fv-anc-10-cl2-operations-on-accounts-marked-as-closed
description: An account bearing a closed discriminator should be rejected at the start of any instruction that would read or mutate it. Failing to check allows a closed account to be passed into an instruction and processed as if still valid.
category: general
---
