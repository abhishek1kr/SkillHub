---
name: fv-sol-6-c2-unchecked-transfer-return
description: Failing to check the return value of transfer or transferFrom on ERC20 tokens allows silent transfer failures to go undetected. Certain tokens return false instead of reverting on failure; ignoring the return value lets execution continu...
category: general
---
