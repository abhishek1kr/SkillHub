---
name: fv-anc-7-cl6-transfer-fee-extension-accounting-error
description: Token-2022 transfer fee extensions deduct a fee from transferred amounts at the SPL level. Programs that send X tokens and expect X tokens to arrive at the destination will undercount the actual received amount. This causes shortfalls in...
category: general
---
