...
description: API authentication profiling: detect and catalog all auth mechanisms (JWT, OAuth2, API keys, Basic, Digest, mTLS, session cookies, HMAC, custom schemes) across API endpoints. Maps auth requirements per path and feeds downstream auth-atta...
category: auth
---
