---
name: standards
description: | OWASP ID | Risk | Data Storage Relevance | |----------|------|----------------------| | M1 | Improper Credential Usage | Hardcoded credentials in SharedPreferences, plists, databases | | M6 | Inadequate Privacy Controls | PII stored un...
category: mobile
---
