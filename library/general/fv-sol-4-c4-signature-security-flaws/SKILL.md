---
name: fv-sol-4-c4-signature-security-flaws
description: Signature-based authentication is vulnerable to three related issues: malleability (the same signing key produces two valid signatures for the same message), zero-address recovery (ecrecover returns address(0) for malformed signatures), ...
category: general
---
