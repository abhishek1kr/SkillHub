---
name: fv-anc-7-cl3-token-2022-incompatibility
description: The legacy SPL Token program and Token-2022 have different program IDs and different instruction formats for operations like transfer. Code that hardcodes anchorspl::token will fail or behave incorrectly when used with Token-2022 mints, ...
category: general
---
