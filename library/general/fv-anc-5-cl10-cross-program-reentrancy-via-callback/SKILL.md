---
name: fv-anc-5-cl10-cross-program-reentrancy-via-callback
description: Solana's CPI depth limit does not prevent reentrancy when program A calls program B which calls back into program A at a different instruction before A's state is finalized. Unlike EVM, there is no automatic reentrancy guard at the runti...
category: general
---
