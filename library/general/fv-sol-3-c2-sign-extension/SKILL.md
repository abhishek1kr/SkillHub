---
name: fv-sol-3-c2-sign-extension
description: Sign extension issues occur when a smaller signed integer type is implicitly or explicitly cast to a larger signed integer type. The sign bit propagates to fill the additional high-order bits, which can turn a small negative value into a...
category: general
---
