---
name: example-usage
description: bash python scripts/supplychainauditor.py --project-dir . --output audit.json python scripts/supplychainauditor.py --project-dir ./myapp --check-registry --output audit.json
category: general
---
