---
name: fv-vyp-3-c1-missing-owner-checks
description: Vyper has no built-in access control modifiers analogous to OpenZeppelin's onlyOwner. Every privileged function must explicitly assert the caller's identity. Missing or misplaced assert msg.sender == self.owner statements leave administr...
category: general
---
