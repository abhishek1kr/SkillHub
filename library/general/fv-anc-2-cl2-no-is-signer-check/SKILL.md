---
name: fv-anc-2-cl2-no-is-signer-check
description: When using raw AccountInfo or native Solana program patterns, the issigner field on the account info must be explicitly checked. Omitting this check means an instruction accepts any account as an authority without verifying it signed the...
category: general
---
