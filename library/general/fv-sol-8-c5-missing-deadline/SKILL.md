---
name: fv-sol-8-c5-missing-deadline
description: Without a meaningful deadline, a swap transaction can be held in the mempool indefinitely by validators and executed at an arbitrary future time when conditions may be unfavorable. deadline = block.timestamp is always valid (the transact...
category: general
---
