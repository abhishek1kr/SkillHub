---
name: fv-ton-2-cl4-initialization-security
description: Contracts whose initialization function is callable by anyone, or re-callable after first deployment, can have their entire state overwritten - including the admin address - by an attacker who sends the init opcode.
category: general
---
