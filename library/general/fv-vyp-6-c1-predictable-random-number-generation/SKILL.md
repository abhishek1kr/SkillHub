---
name: fv-vyp-6-c1-predictable-random-number-generation
description: Vyper provides no native source of verifiable randomness. Contracts that derive randomness from block.timestamp, blockhash, block.prevrandao, or combinations thereof are vulnerable to manipulation by validators or to pre-computation by a...
category: general
---
