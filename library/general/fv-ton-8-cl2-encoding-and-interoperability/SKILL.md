---
name: fv-ton-8-cl2-encoding-and-interoperability
description: Tact structs and messages serialize to cells using Tact's own encoding conventions. When a Tact contract sends messages to a FunC contract (or vice versa), field widths, layout, and op codes must match exactly - silent mismatches cause i...
category: general
---
