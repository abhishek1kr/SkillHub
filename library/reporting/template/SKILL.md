---
name: template
description: | Finding | Severity | Endpoint | Impact | |---------|----------|----------|--------| | Operator Injection | Critical | POST /api/login | Authentication Bypass | | Blind Regex Extraction | High | POST /api/login | Data Leakage | | $where...
category: reporting
---
