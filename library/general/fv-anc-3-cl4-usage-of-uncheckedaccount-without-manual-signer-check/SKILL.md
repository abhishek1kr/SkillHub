---
name: fv-anc-3-cl4-usage-of-uncheckedaccount-without-manual-signer-check
description: When UncheckedAccount<'info is used for an account that is expected to authorize an action, the issigner field must be explicitly checked in the instruction body. Anchor does not perform this check automatically for unchecked account types.
category: general
---
