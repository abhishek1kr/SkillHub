---
name: fv-anc-7-cl5-interest-bearing-mint-principal-vs-balance-confusion
description: Token-2022 interest-bearing mints compound an on-chain rate that increases the displayed token balance over time. Programs that read the raw TokenAccount.amount without calling the extension's amounttouiamount conversion will undercount ...
category: general
---
