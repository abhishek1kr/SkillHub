---
name: fv-ton-6-cl1-set-code-and-state-migration
description: setcode() takes effect only for subsequent transactions, not the current one. Code upgrades without a matching storage migration leave the new code reading old data in the wrong format - silently corrupting balances, access control, and ...
category: general
---
