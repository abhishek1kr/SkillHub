---
name: readme
description: The "turn one-shot recon into a program" layer — scheduled re-scan-and-diff loops, adversary CTI/ chatter monitoring, infrastructure-tracking-over-time, and finding-lifecycle discipline so a client gets told about new exposure instead of...
category: recon
---
