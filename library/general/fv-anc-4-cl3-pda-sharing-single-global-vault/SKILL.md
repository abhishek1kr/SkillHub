---
name: fv-anc-4-cl3-pda-sharing-single-global-vault
description: A vault PDA derived from constant seeds (e.g., only b"vault") is shared across all users or positions. Compromising any single user's position, or exploiting any instruction that touches the vault, can drain funds belonging to all other ...
category: general
---
