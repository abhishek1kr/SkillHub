---
name: fv-anc-4-cl5-pda-signer-without-ownership-verification
description: Using invokesigned with PDA seeds to authorize a CPI without first verifying the PDA account is owned by the calling program allows a forged PDA from a different program to authorize operations it should not perform. If two programs can ...
category: general
---
