...
description: postMessage cross-origin messaging testing: missing origin validation in message event handler, arbitrary message injection, sensitive data leak via postMessage, and XSS via postMessage to eval/innerHTML sink. Use when testing SPAs and b...
category: xss
---
