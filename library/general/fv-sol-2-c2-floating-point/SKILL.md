---
name: fv-sol-2-c2-floating-point
description: Solidity has no native floating-point type. Contracts that perform division before multiplication on integer values silently truncate fractional parts, producing results that are systematically wrong - often rounding small values to zero...
category: general
---
