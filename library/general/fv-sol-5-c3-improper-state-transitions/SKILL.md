---
name: fv-sol-5-c3-improper-state-transitions
description: A contract with a defined lifecycle (e.g., NotStarted, Active, Paused, Completed) allows state-modifying functions to execute without validating the current state, permitting out-of-order or repeated transitions that violate invariants a...
category: general
---
