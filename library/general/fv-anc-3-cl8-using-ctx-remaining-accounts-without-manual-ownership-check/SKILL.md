---
name: fv-anc-3-cl8-using-ctx-remaining-accounts-without-manual-ownership-check
description: ctx.remainingaccounts provides raw AccountInfo references with no Anchor-enforced constraints. Every account taken from this slice must be manually validated for ownership before its data is read or it is passed to a CPI, otherwise an at...
category: general
---
