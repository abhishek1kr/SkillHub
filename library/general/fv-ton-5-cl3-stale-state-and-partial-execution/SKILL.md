---
name: fv-ton-5-cl3-stale-state-and-partial-execution
description: In multi-message operations, each sent message creates a separate committed transaction. If any message in the chain fails (bounces or runs out of gas), prior state changes are already committed and require explicit rollback via bounce h...
category: general
---
