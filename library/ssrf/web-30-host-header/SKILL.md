...
description: Host header injection testing skill for offensive security. Covers password reset poisoning, SSRF via Host header, virtual host discovery, cache poisoning, port injection, ambiguous Host headers, and IP-based access control bypass. Use w...
category: ssrf
---
