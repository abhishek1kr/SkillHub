---
name: amm-dex
description: Applies to: Dedust-style AMM protocols, STON.fi-style swap contracts, liquidity pool contracts on TON, swap routers, Jetton-based liquidity pools, any FunC or Tact contract implementing constant-product or curve-based invariant math, pos...
category: general
---
