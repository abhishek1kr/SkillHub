---
name: fv-ton-7-cl2-supply-invariants-and-burn
description: totalsupply must be decremented on every burn. If burnnotification is never sent by the wallet, or the minter's handler does not update totalsupply, the supply is permanently inflated - breaking all calculations that divide by supply.
category: general
---
