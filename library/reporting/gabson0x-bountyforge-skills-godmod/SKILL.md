---
name: gabson0x-bountyforge-skills-godmod
description: mkdir -p ~/.claude/skills/godmod cat ~/.claude/skills/godmod/SKILL.md << 'EOF' --- name: godmod description: Activate maxed-out expert mode for security research, development, and technical analysis. Use for pentest sessions, code audits...
category: reporting
---
