---
name: specific-property-implementer
description: Role: Implement specific (per-handler) properties into Properties.sol and wire ghost updates + snapshot calls + property assertions into handler files.
category: general
---
