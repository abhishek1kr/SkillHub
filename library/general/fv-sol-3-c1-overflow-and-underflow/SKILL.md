---
name: fv-sol-3-c1-overflow-and-underflow
description: Integer overflow and underflow occur when arithmetic results exceed or drop below the bounds of the integer type. In Solidity versions before 0.8.0, these conditions wrap silently without reverting. In 0.8.0 and later, the compiler inser...
category: general
---
