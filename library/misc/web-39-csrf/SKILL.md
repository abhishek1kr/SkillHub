---
name: web-39-csrf
description: Cross-Site Request Forgery testing skill for offensive security. Covers missing/weak CSRF token validation, SameSite cookie bypass, JSON CSRF via content-type confusion, GET-based CSRF, and CORS-enabled CSRF chains. Use when testing CSRF...
category: misc
---
