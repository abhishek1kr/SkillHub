---
name: fv-anc-1-cl2-division-by-zero
description: Division by zero in an Anchor instruction causes a panic and transaction failure. When the divisor is derived from user-supplied input or an account field, an attacker can trigger a denial-of-service by passing zero.
category: general
---
