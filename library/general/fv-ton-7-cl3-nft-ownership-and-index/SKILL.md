---
name: fv-ton-7-cl3-nft-ownership-and-index
description: NFT item ownership can be overwritten by unauthorized parties if the transfer handler lacks a current-owner check, and the collection index can be manipulated to mint duplicate items or overwrite existing ones if nextitemindex is not ato...
category: general
---
