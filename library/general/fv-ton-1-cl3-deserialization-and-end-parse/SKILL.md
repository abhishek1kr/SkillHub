---
name: fv-ton-1-cl3-deserialization-and-end-parse
description: Omitting endparse() after deserializing a message or storage slice silently ignores trailing bytes, masking injected extra data, storage corruption, or format version mismatches.
category: general
---
