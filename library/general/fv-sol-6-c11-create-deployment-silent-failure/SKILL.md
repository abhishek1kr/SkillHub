---
name: fv-sol-6-c11-create-deployment-silent-failure
description: Assembly create(v, offset, size) and create2(v, offset, size, salt) return address(0) on failure - insufficient ETH balance, address collision, or init code revert. Unlike the high-level new Contract() syntax, these opcodes do not revert...
category: general
---
