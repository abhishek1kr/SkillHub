---
name: web-22-csti
description: Client-Side Template Injection (CSTI): Angular sandbox escape, Vue template injection, React dangerouslySetInnerHTML abuse, and client-side template engine (Handlebars/Mustache/Underscore) XSS. Distinguish from SSTI — template evaluated ...
category: xss
---
