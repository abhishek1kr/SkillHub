---
name: fv-vyp-8-c1-division-by-zero
description: Vyper reverts on division by zero for integer types, but the revert is an unhandled exception that may occur at unexpected points in execution, leaving state partially modified if writes preceded the division. Contracts must validate div...
category: general
---
