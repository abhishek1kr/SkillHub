---
name: example-usage
description: Authorization first. Adversary emulation runs real attack techniques. Confirm written scope, a deconfliction channel with the SOC, and an abort procedure before any live execution (see the Authorization Gate in SKILL.md). Planning, cover...
category: reporting
---
