---
name: fv-anc-13-cl2-uninitialized-vec-capacity-bug
description: Creating a Vec with Vec::withcapacity(n) allocates space for n elements but leaves the length at 0. Accessing elements of a capacity-allocated but not length-populated Vec via index operators will produce an out-of-bounds panic. If an in...
category: general
---
