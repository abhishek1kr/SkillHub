---
name: fv-sol-10-c4-time-lags
description: Delaying block production or influencing the timing of oracle updates causes the price feed to serve stale data. Protocols that accept arbitrarily old prices expose themselves to exploitation using valuations that no longer reflect marke...
category: general
---
