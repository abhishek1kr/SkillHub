---
name: fv-anc-8-cl3-address-lookup-table-signer-forgery
description: Address Lookup Tables (ALTs) expand transaction account lists from compressed indices. A malicious transaction can use an ALT to inject accounts that appear at indices the program expects to belong to specific signers or programs. Progra...
category: general
---
