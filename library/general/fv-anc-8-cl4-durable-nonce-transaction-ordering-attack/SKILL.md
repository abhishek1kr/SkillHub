---
name: fv-anc-8-cl4-durable-nonce-transaction-ordering-attack
description: Durable nonce transactions replace the recentblockhash field with a nonce value that does not expire with slots, allowing a signed transaction to be submitted at any future time. Protocols that rely on transaction recency for security (s...
category: general
---
