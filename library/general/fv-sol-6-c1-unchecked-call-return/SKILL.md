---
name: fv-sol-6-c1-unchecked-call-return
description: Low-level calls (call, delegatecall, staticcall, send) return a boolean success flag instead of reverting on failure. When the return value is discarded the caller continues execution under the false assumption that the operation succeed...
category: general
---
