...
description: Applies to: cross-chain bridge contracts on TON, TON-to-EVM bridges, Jetton bridge contracts, DAO governance contracts, multisig-controlled protocols, proposal-and-vote governance, timelock controllers, admin key management, any FunC or ...
category: network
---
