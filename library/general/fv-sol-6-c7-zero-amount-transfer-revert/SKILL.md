---
name: fv-sol-6-c7-zero-amount-transfer-revert
description: Some non-standard ERC20 tokens (LEND, early BNB, and others) revert on transfer(to, 0) or transferFrom(from, to, 0). Protocols that perform distribution loops or yield claims without guarding against zero amounts will be DoS'd when the d...
category: general
---
