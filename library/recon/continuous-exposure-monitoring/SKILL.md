...
description: Turns one-shot external recon into a continuous monitoring program. Covers the scheduled re-scan-and-diff loop (baseline snapshot - interval sleep - re-scan - asset/finding delta - threshold-gated webhook alert), the scan-to-scan diff en...
category: recon
---
