---
name: fv-sol-8-c3-insufficient-liquidity
description: When a DEX pool has insufficient liquidity relative to the swap size, price impact grows non-linearly and the resulting output can be drastically below fair value. Without a pre-swap liquidity check or a tightly enforced amountOutMinimum...
category: general
---
