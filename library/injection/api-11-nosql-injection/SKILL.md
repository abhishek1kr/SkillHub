...
description: API NoSQL injection testing: MongoDB operator injection ($ne, $gt, $regex, $where), blind NoSQL via $regex character extraction, JSON body injection in REST APIs, and GraphQL NoSQLi via filter arguments. Use when testing APIs using Mongo...
category: injection
---
