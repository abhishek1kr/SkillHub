---
name: fv-mov-4-cl1-shared-object-races
description: Concurrent transactions targeting the same shared object can interleave reads and writes without a version or sequence check. The second writer overwrites the first writer's result, causing lost updates - for example, two deposits each r...
category: general
---
