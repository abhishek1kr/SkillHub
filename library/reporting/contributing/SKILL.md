---
name: contributing
description: 1. Fork the repo and create a branch from main. 2. Make your changes — attack vectors, agent prompts, report formatting, or documentation. 3. Ensure your branch is up to date with main before opening a PR. 4. Do not edit VERSION — it is ...
category: reporting
---
