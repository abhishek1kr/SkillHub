...
description: Multi-tenant isolation testing: cross-tenant data access via IDOR/BOLA, tenant ID manipulation in JWT/headers/body, SSRF between tenant partitions, shared resource contention, and cloud tenancy boundary bypass. Use when testing SaaS/clou...
category: auth
---
