---
name: fv-mov-3-cl4-upgrade-cap-security
description: The UpgradeCap for a Sui package is the single object controlling all future code upgrades. A compromised or malicious holder can deploy arbitrary new code, immediately draining all protocol funds. This is the highest-impact single point...
category: general
---
