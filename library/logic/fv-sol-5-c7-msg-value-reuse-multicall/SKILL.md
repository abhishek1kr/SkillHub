---
name: fv-sol-5-c7-msg-value-reuse-multicall
description: msg.value is a global that persists for the entire transaction. Reading it inside a loop or inside delegatecall-based multicall credits the full original ETH value on every iteration - a single payment appears as N payments.
category: logic
---
