---
name: fv-ton-1-cl1-transfer-notification-sender-validation
description: transfernotification (op 0x7362d09c) handlers that do not verify senderaddress against the stored Jetton wallet address allow attackers to fake token deposits by sending a crafted message from any contract.
category: general
---
