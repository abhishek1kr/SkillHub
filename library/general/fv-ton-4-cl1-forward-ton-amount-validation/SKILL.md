---
name: fv-ton-4-cl1-forward-ton-amount-validation
description: A user-controlled forwardtonamount used directly in sendrawmessage without validating it against msgvalue lets attackers specify a large forward amount while sending minimal gas - the contract covers the difference from its own balance.
category: general
---
