...
description: API documentation leakage testing skill. Covers exposed Swagger/OpenAPI endpoints, debug endpoints, internal API documentation, GraphQL introspection, and sensitive information in API responses. Use when searching for unintended API docu...
category: misc
---
