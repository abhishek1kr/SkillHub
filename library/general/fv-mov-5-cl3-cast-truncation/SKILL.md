---
name: fv-mov-5-cl3-cast-truncation
description: Unlike standard arithmetic, Move's type casts (value as u64, value as u8) silently truncate high bits without aborting. A u128 value of 2^64 + 100 cast to u64 becomes 100, bypassing amount checks. This is distinct from arithmetic overflo...
category: general
---
