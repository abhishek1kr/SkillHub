---
name: fv-ton-2-cl2-replay-protection
description: External message handlers without sequence number validation, or with seqno incremented after execution rather than before, allow valid signed messages to be replayed indefinitely - re-executing transfers, withdrawals, or any privileged ...
category: general
---
