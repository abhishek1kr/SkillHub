...
description: DOM Clobbering: overwriting JavaScript global variables via HTML element ID attributes (e.g., <a id=config hijacks window.config), bypassing CSP via trusted anchor injection, and framework-specific clobbering (Angular, React, jQuery). Us...
category: xss
---
