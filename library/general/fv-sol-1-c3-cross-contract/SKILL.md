---
name: fv-sol-1-c3-cross-contract
description: An attacker deploys a dedicated malicious contract that acts as msg.sender and re-enters the victim contract during an external call callback. The malicious contract's receive or fallback calls back into the victim before the victim's st...
category: general
---
