---
name: fv-mov-4-cl2-hot-potato-flash-loan
description: The hot potato pattern enforces flash loan repayment by making the receipt struct have no abilities - the compiler requires it to be consumed in the same PTB. Two failure modes: (1) receipt struct has drop or store ability, breaking enfo...
category: general
---
