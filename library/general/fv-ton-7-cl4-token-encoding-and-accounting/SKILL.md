---
name: fv-ton-7-cl4-token-encoding-and-accounting
description: Mixing storecoins/loadcoins (variable-length) with storeuint/loaduint (fixed-width) on the same field corrupts the cell layout. Using raw contract balance instead of internally tracked deposits allows balance manipulation through direct ...
category: general
---
