---
name: fv-anc-7-cl4-token-2022-transfer-hook-bypass-or-missing
description: Token-2022 mints can register a transfer hook program that must be invoked on every token transfer. Programs that use the legacy spltoken::transfer instruction or call the SPL Token program ID directly (TokenkegQfe...) bypass the hook en...
category: general
---
