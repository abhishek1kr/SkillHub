---
name: fv-sol-7-c5-proxy-implementation-attacks
description: Implementation contracts are not just storage targets - they are execution contexts with their own attack surface. Vulnerabilities include immutable variable context mismatch across proxies, arbitrary delegatecall exposed in the implemen...
category: general
---
