---
name: fv-sol-7-c2-function-selector-collision
description: Function selectors are the first four bytes of the keccak256 hash of a function signature. When a proxy contract exposes public functions whose selectors match functions in the implementation, the proxy intercepts and handles those calls...
category: general
---
