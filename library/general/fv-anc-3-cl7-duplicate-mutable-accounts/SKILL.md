---
name: fv-anc-3-cl7-duplicate-mutable-accounts
description: When two mutable account fields in an Anchor context can be satisfied by the same public key, an attacker can pass the same account for both. Instructions that assume the accounts are distinct (e.g., transferring between them) will produ...
category: general
---
