---
name: api-reference
description: | Platform | Hijack Vector | |----------|---------------| | GitHub | Register abandoned username/repo | | npm | Publish unclaimed package name | | PyPI | Register unclaimed package | | Twitter/X | Claim abandoned handle | | BitBucket | R...
category: recon
---
