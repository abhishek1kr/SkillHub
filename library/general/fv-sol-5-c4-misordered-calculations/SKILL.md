---
name: fv-sol-5-c4-misordered-calculations
description: Arithmetic operations applied in the wrong sequence produce incorrect results. Common cases include applying a bonus before a tax so the bonus is also taxed, computing interest before updating the principal, or applying a percentage to a...
category: general
---
