---
name: fv-sol-6-c3-silent-fail
description: A function call fails without detection and execution continues as if it succeeded, producing an invalid or inconsistent contract state. This pattern arises whenever a callee signals failure through a return value rather than a revert an...
category: general
---
