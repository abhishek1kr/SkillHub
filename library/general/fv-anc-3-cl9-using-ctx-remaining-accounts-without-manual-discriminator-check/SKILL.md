---
name: fv-anc-3-cl9-using-ctx-remaining-accounts-without-manual-discriminator-check
description: Accounts from ctx.remainingaccounts bypass Anchor's automatic discriminator verification. Without checking the first 8 bytes against the expected Anchor discriminator, an attacker can pass an account of a different struct type that share...
category: general
---
