---
name: fv-anc-1-cl1-overflow-underflow-in-arithmetic-operations
description: Integer overflow and underflow in Rust Anchor programs occur when arithmetic on u64/u128/i64 values wraps or panics, leading to corrupted balances, bypassed caps, or exploitable logic. In release builds, Rust integers wrap silently unles...
category: general
---
