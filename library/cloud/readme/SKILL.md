---
name: readme
description: The "is this actually the client's cloud risk" layer — bucket discovery with an ownership-gated severity model, offline AWS-account-ID recovery from a leaked access key, dependency-confusion confirmation for npm/PyPI, and passive cloud-n...
category: cloud
---
