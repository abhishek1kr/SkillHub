---
name: fv-sol-1-c9-transient-storage-reentrancy
description: Two reentrancy risks introduced by EIP-1153 (Cancun, March 2024): first, the classic transfer()/send() 2300-gas reentrancy guard is bypassed because TSTORE costs only 100 gas, allowing a receive() fallback to write transient state and re...
category: general
---
