---
name: api-reference
description: | Library | Install | Purpose | |---------|---------|---------| | adversarial-robustness-toolbox | pip install adversarial-robustness-toolbox | Extraction, inversion, and membership-inference attacks + defenses | | scikit-learn | pip ins...
