---
name: fv-vyp-3-c2-role-based-access-control-flaws
description: Vyper has no native role system. Contracts that implement role hierarchies using HashMap[address, bool] are prone to privilege escalation when lower-privileged roles can grant themselves or others higher privileges, or when role checks a...
category: general
---
