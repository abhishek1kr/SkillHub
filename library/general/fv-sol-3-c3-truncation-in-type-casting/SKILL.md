---
name: fv-sol-3-c3-truncation-in-type-casting
description: Downcasting from a wider integer type to a narrower one silently drops the high-order bits. Any value larger than the target type's maximum is truncated to its low-order bits, producing a different value with no revert or warning. This a...
category: general
---
