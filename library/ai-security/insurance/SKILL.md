---
name: insurance
description: Applies to: on-chain insurance protocols, coverage protocols, risk pools, parametric insurance, claims processing, Nexus Mutual-style, InsurAce-style
