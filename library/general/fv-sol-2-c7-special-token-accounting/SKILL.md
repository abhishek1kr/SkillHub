---
name: fv-sol-2-c7-special-token-accounting
description: Three related token behaviors break standard balance accounting assumptions: fee-on-transfer tokens deduct a fee during transferFrom so the contract records more than it received; rebasing tokens (stETH, AMPL, aTokens) change balanceOf o...
category: general
---
