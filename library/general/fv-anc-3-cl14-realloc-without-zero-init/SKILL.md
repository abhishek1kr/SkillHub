---
name: fv-anc-3-cl14-realloc-without-zero-init
description: Anchor's realloc constraint expands an account's data allocation. When realloc::zeroinit = false, newly exposed bytes from the previous allocation are not zeroed and may contain stale data from prior account usage. Reading those bytes as...
category: general
---
