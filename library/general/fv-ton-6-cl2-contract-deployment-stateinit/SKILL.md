---
name: fv-ton-6-cl2-contract-deployment-stateinit
description: Child contracts deployed without StateInit are never created, causing messages to bounce or funds to be lost. Address computation using different code or data than the actual StateInit sends messages to the wrong address - which may be a...
category: general
---
