---
name: fv-sol-1-c1-single-function
description: A single function performs an external call before updating its own state. An attacker's receive or fallback function re-enters the same function before the state change lands, allowing repeated withdrawal of the same balance within one ...
category: general
---
