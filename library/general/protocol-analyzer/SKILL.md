...
description: Role: Perform manual protocol analysis when x-ray is unavailable, and produce a protocol-understanding.md file that downstream steps (4, 6, 7, 9) can read back as their protocol context.
category: general
---
