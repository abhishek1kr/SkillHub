---
name: fv-anc-3-cl2-trying-to-access-account-data-without-ownership-checks
description: On Solana, any account can be passed to a program. Without verifying that an account is owned by the expected program, an attacker can substitute a look-alike account controlled by a different program, causing the instruction to operate ...
category: general
---
