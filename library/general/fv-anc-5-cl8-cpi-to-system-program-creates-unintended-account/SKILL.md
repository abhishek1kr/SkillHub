---
name: fv-anc-5-cl8-cpi-to-system-program-creates-unintended-account
description: A CPI to the system program's createaccount or assign instruction with attacker-influenced parameters can create or reassign accounts at addresses that hold special protocol meaning. If the target address is a protocol PDA, config accoun...
category: general
---
