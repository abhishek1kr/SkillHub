---
name: fv-sol-5-c1-boundary-misalignment
description: Occurs when code fails to correctly define exclusive versus inclusive boundaries at interval thresholds, causing values at the cutoff to fall into the wrong range, be double-counted, or be skipped entirely.
category: general
---
