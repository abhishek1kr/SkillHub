---
name: fv-anc-5-cl9-cpi-privilege-escalation-via-account-authority
description: When accounts passed into a CPI carry iswritable or issigner flags that originated from the outer transaction context, an attacker can escalate privileges inside the CPI by crafting the outer transaction's account flags. Anchor's CpiCont...
category: logic
---
