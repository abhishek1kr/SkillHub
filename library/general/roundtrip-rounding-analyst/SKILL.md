---
name: roundtrip-rounding-analyst
description: Discovery approach: For every paired operation and conversion function, verify that round-trips don't create value and rounding always favors the protocol.
category: general
---
