---
name: fv-mov-6-cl1-coin-balance-confusion
description: Sui separates Coin<T (an object with a UID, transferable) from Balance<T (an internal primitive value without an object ID). Mixing these without consistent accounting creates ghost balances - coins exist on-chain with no internal tracki...
category: general
---
