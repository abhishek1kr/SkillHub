---
name: fv-mov-2-cl3-entry-visibility-bypass
description: A function declared public(package) entry is intended to be callable only within the package, but the entry modifier allows it to be called directly from any transaction. The entry keyword overrides the public(package) restriction, turni...
category: general
---
