...
description: API mass assignment testing: privileged field injection via JSON/XML body, nested object manipulation, API version differentials, hidden parameter discovery, and framework-specific autobinding bypass. Use when testing APIs with automatic...
category: auth
---
