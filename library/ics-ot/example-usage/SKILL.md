---
name: example-usage
description: Safety first: default to passive analysis. Active probing only with asset-owner sign-off, on a bench or maintenance window, never against Safety Instrumented Systems (SIS).
category: ics-ot
---
