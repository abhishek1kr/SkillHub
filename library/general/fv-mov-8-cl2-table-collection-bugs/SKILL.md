---
name: fv-mov-8-cl2-table-collection-bugs
description: table::add aborts on duplicate keys - missing existence checks cause DoS when a user interacts a second time. Move vectors are limited to ~1000 entries - unbounded vectors DoS when full. Both create permanent denial-of-service.
category: general
---
