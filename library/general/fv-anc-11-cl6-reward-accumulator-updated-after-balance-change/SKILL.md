---
name: fv-anc-11-cl6-reward-accumulator-updated-after-balance-change
description: Staking and reward protocols that track per-share reward accumulation must update the global accumulator index before modifying any user's share balance. If the index is updated after a deposit or withdrawal, the user's new balance is us...
category: general
---
