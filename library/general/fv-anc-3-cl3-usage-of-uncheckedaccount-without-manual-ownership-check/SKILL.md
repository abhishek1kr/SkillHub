---
name: fv-anc-3-cl3-usage-of-uncheckedaccount-without-manual-ownership-check
description: UncheckedAccount<'info explicitly bypasses Anchor's automatic ownership and discriminator verification. Any instruction using this type must manually perform the ownership checks that Account<'info, T would otherwise enforce, or an attac...
category: general
---
