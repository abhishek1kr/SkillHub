---
name: fv-ton-5-cl1-async-reentrancy
description: TON's actor model enables reentrancy through message ordering rather than call stacks: a contract sends a message and another message arrives before the callback, reading and modifying state between the send and the response - each as se...
category: general
---
