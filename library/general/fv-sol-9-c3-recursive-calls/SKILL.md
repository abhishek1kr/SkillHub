---
name: fv-sol-9-c3-recursive-calls
description: Solidity imposes a call-stack depth limit of 1024 frames. Recursive self-calls or chains of delegating function calls that scale with user-supplied input will exhaust the call stack or gas budget before completing. Even when disguised as...
category: general
---
