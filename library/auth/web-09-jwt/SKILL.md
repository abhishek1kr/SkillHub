---
name: web-09-jwt
description: JWT attack methodology for web applications: algorithm confusion (alg:none, RS256→HS256), kid injection, jku/x5u/jwk header tampering, token replay, session handling flaws, and cookie-based JWT storage attacks. Use when testing web JWT a...
category: auth
---
