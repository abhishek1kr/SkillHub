...
description: Clickjacking and UI redressing testing skill for offensive security. Covers missing X-Frame-Options, CSP frame-ancestors bypass, drag-and-drop hijacking, multi-step clickjacking, and mobile-specific framing attacks. Use when testing for ...
category: xss
---
