---
name: fv-anc-5-cl5-sol-balance-drain-via-cpi
description: When a program passes an account with a SOL balance to an external program via CPI, the callee can debit lamports from that account if it holds write authority. Without checking the balance before and after the CPI, the caller cannot det...
category: general
---
