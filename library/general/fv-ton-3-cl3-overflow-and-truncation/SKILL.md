---
name: fv-ton-3-cl3-overflow-and-truncation
description: While TVM 257-bit integer arithmetic throws on overflow by default, intermediate calculations involving storeuint/loaduint with smaller widths silently truncate, and unbounded accumulators can overflow before being packed.
category: general
---
