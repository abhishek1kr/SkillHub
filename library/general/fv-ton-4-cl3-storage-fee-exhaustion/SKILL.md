---
name: fv-ton-4-cl3-storage-fee-exhaustion
description: TON contracts pay continuous storage fees. Without minimum-balance reserves, operations that reduce the balance to near-zero cause the contract to be frozen - permanently inaccessible until someone sends TON to unfreeze it.
category: general
---
