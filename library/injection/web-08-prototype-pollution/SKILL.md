...
description: Prototype pollution testing: proto injection via JSON body, query parameters, and merge/clone operations. Covers detection in Node.js apps, escalation to XSS, RCE, and auth bypass via polluting Object.prototype. Use when testing JavaScri...
category: injection
---
