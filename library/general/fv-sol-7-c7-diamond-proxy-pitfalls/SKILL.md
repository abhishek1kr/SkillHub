---
name: fv-sol-7-c7-diamond-proxy-pitfalls
description: EIP-2535 Diamond proxies introduce unique storage and selector collision risks beyond standard proxy patterns. Facets that declare top-level state variables all start at slot 0, overwriting each other's data. Adding a facet with a select...
category: general
---
