---
name: lending
description: Applies to: Scallop, Navi Protocol, Suilend, Bucket Protocol, any Move module implementing collateralized lending, overcollateralized borrowing, CDP (collateralized debt position), flash loan providers, yield vaults, share-based deposit ...
category: cloud
---
