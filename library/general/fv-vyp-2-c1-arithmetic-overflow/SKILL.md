---
name: fv-vyp-2-c1-arithmetic-overflow
description: In Vyper 0.3.x and earlier, arithmetic on integer types does not revert on overflow by default in all compilation modes. In Vyper 0.4.x the behavior changed, but code compiled with older compiler versions or with @pragma optimize can sil...
category: general
---
